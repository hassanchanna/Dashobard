...
if(isset($_GET['proId'])){
	$proId = $_GET['proId'];
	$query = $pdo ->prepare("SELECT `products`.*, `categories`.`catName`
FROM `products` 
...
?>
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-100 p-lr-0-lg">
			...
			<a href="product.php?catId=<?php echo $detail['productCatId']?>" class="stext-109 cl8 hov-cl1 trans-04">
				<?php echo $detail['catName']?>
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a>
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="<?php echo $proImageAddress.$detail['productImage']?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?php echo $proImageAddress.$detail['productImage']?>" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo $proImageAddress.$detail['productImage']?>">
